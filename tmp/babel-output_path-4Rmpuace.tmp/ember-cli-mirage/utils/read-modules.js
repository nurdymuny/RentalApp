define('ember-cli-mirage/utils/read-modules', ['exports', 'ember', 'lodash/object/keys', 'lodash/string/camelCase', 'ember-cli-mirage/utils/inflector'], function (exports, _ember, _lodashObjectKeys, _lodashStringCamelCase, _emberCliMirageUtilsInflector) {
  'use strict';
  ...
  */
  ...
  exports['default'] = function (prefix) {
    ...
    (0, _lodashObjectKeys['default'])(requirejs.entries).filter(function (key) {
      ...
      _ember['default'].assert('Subdirectories under i' + moduleType + ' are not supported', moduleParts[moduleParts.length - 3] === 'mirage');

      if (moduleType === 'scenario') {
        _ember['default'].assert('Only scenario/default.js is supported at this time.', moduleKey !== 'default');
      }
