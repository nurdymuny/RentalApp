define('ember-cli-mirage/orm/associations/has-many', ['exports', 'ember-cli-mirage/orm/associations/association', 'ember-cli-mirage/orm/collection', 'lodash/object/assign', 'lodash/array/compact', 'ember-cli-mirage/utils/inflector', 'ember-cli-mirage/assert'], function (exports, _emberCliMirageOrmAssociationsAssociation, _emberCliMirageOrmCollection, _lodashObjectAssign, _lodashArrayCompact, _emberCliMirageUtilsInflector, _emberCliMirageAssert) {
  'use strict';
      ...
      value: function addMethodsToModelClass(ModelClass, key, schema) {
        ...
        Object.defineProperty(modelPrototype, relationshipIdsKey, {
          ...
          */
          get: function get() {
            ...
            if (!this.isNew()) {
              ...
              var savedChildren = schema[(0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(association.modelName))].where(query);
          ...
          */
          set: function set(ids) {
            ...
            if (this.isNew()) {
              association._cachedChildren = schema[(0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(association.modelName))].find(ids);
            } else {
              // Set current children's fk to null
              var query = _defineProperty({}, foreignKey, this.id);
              schema[(0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(association.modelName))].where(query).update(foreignKey, null);

              // Associate the new childrens to this model
              schema[(0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(association.modelName))].find(ids).update(foreignKey, this.id);
          ...
          */
          set: function set(models) {
            ...
            if (this.isNew()) {
              ...
              schema[(0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(association.modelName))].find(models.map(function (m) {
                return m.id;
        ...
        */
        modelPrototype['new' + (0, _emberCliMirageUtilsInflector.capitalize)((0, _emberCliMirageUtilsInflector.camelize)((0, _emberCliMirageUtilsInflector.singularize)(association.key)))] = function () {
          ...
          var child = schema[(0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(association.modelName))]['new'](attrs);
        ...
        */
        modelPrototype['create' + (0, _emberCliMirageUtilsInflector.capitalize)((0, _emberCliMirageUtilsInflector.camelize)((0, _emberCliMirageUtilsInflector.singularize)(association.key)))] = function () {
          ...
          var child = schema[(0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(association.modelName))].create(augmentedAttrs);
