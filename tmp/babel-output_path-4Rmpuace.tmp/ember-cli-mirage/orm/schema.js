define('ember-cli-mirage/orm/schema', ['exports', 'ember-cli-mirage/utils/inflector', 'ember-cli-mirage/orm/associations/association', 'ember-cli-mirage/orm/collection', 'lodash/lang/isArray', 'lodash/object/forIn', 'lodash/collection/includes', 'ember-cli-mirage/assert'], function (exports, _emberCliMirageUtilsInflector, _emberCliMirageOrmAssociationsAssociation, _emberCliMirageOrmCollection, _lodashLangIsArray, _lodashObjectForIn, _lodashCollectionIncludes, _emberCliMirageAssert) {
  'use strict';
  ...
  var Schema = (function () {
    ...
    _createClass(Schema, [{
      ...
      value: function registerModel(type, ModelClass) {
        ...
        for (var associationProperty in ModelClass.prototype) {
          if (ModelClass.prototype[associationProperty] instanceof _emberCliMirageOrmAssociationsAssociation['default']) {
            ...
            association.modelName = association.modelName || (0, _emberCliMirageUtilsInflector.dasherize)((0, _emberCliMirageUtilsInflector.singularize)(associationProperty));
            association.ownerModelName = (0, _emberCliMirageUtilsInflector.dasherize)(camelizedModelName);
        ...
        var collection = (0, _emberCliMirageUtilsInflector.pluralize)(camelizedModelName);
        if (!this.db[collection]) {
          this.db.createCollection(collection);
        }

        // Create the entity methods
        this[(0, _emberCliMirageUtilsInflector.pluralize)(camelizedModelName)] = {
      ...
      value: function find(type, ids) {
        ...
        if ((0, _lodashLangIsArray['default'])(ids)) {
      ...
      */
      ...
      value: function _hydrate(records, modelName) {
        if ((0, _lodashLangIsArray['default'])(records)) {
