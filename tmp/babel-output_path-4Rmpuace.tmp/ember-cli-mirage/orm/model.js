define('ember-cli-mirage/orm/model', ['exports', 'ember-cli-mirage/utils/inflector', 'ember-cli-mirage/utils/extend', 'ember-cli-mirage/assert', 'ember-cli-mirage/orm/collection'], function (exports, _emberCliMirageUtilsInflector, _emberCliMirageUtilsExtend, _emberCliMirageAssert, _emberCliMirageOrmCollection) {
  'use strict';
  ...
  */
  ...
  var Model = (function () {
    ...
    _createClass(Model, [{
      key: 'save',
      value: function save() {
        var collection = (0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(this.modelName));
      ...
      value: function isNew() {
        ...
        if (hasId) {
          var collectionName = (0, _emberCliMirageUtilsInflector.pluralize)((0, _emberCliMirageUtilsInflector.camelize)(this.modelName));
