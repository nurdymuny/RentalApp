define('ember-cli-mirage/db-collection', ['exports', 'lodash/object/assign', 'lodash/lang/isArray', 'lodash/lang/isEqual', 'lodash/collection/sortBy'], function (exports, _lodashObjectAssign, _lodashLangIsArray, _lodashLangIsEqual, _lodashCollectionSortBy) {
  'use strict';
  ...
  function duplicate(data) {
    if ((0, _lodashLangIsArray['default'])(data)) {
    ...
    _createClass(DbCollection, [{
      ...
      value: function update(target, attrs) {
        ...
        if (typeof attrs === 'undefined') {
          ...
          return record;
        } else if ((0, _lodashLangIsArray['default'])(target)) {
          var ids = target;
