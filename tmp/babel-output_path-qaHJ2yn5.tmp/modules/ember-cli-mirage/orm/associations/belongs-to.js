    ...
    */
    ...
    value: function addMethodsToModelClass(ModelClass, key, schema) {
      ...
      Object.defineProperty(modelPrototype, this.getForeignKey(), {
        ...
        */
        set: function set(id) {
          assert(!id || schema.db[pluralize(camelize(association.modelName))].find(id), 'Couldn\'t find ' + association.modelName + ' with id = ' + id);
      ...
      */
      modelPrototype['new' + capitalize(key)] = function (attrs) {
        var parent = schema[pluralize(camelize(association.modelName))]['new'](attrs);
      ...
      */
      modelPrototype['create' + capitalize(key)] = function (attrs) {
        var parent = schema[pluralize(camelize(association.modelName))].create(attrs);
