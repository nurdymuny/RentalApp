    ...
    value: function addMethodsToModelClass(ModelClass, key, schema) {
        ...
        */
        get: function get() {
          ...
          if (!this.isNew()) {
            ...
            var savedChildren = schema[pluralize(camelize(association.modelName))].where(query);
        ...
        */
        set: function set(models) {
          ...
          if (this.isNew()) {
            ...
            schema[pluralize(camelize(association.modelName))].find(models.map(function (m) {
              return m.id;
      ...
      */
      modelPrototype['new' + capitalize(camelize(singularize(association.key)))] = function () {
        ...
        var child = schema[pluralize(camelize(association.modelName))]['new'](attrs);
      ...
      */
      modelPrototype['create' + capitalize(camelize(singularize(association.key)))] = function () {
        ...
        var child = schema[pluralize(camelize(association.modelName))].create(augmentedAttrs);
